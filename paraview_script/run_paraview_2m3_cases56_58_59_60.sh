#!/bin/bash
# Run paraview_script_2m3_linux.py for cases 56, 58, 59, 60, both H2 and U modes.
# Each case × mode is run sequentially to avoid memory issues.
#
# Usage:
#   bash run_paraview_2m3_cases56_58_59_60.sh
#   bash run_paraview_2m3_cases56_58_59_60.sh --debug    # last time step only
...
for CASE in "${CASES[@]}"; do
    CASE_NAME="2m3_27mm_wall_H2_test_${CASE}"
